...
document.addEventListener("DOMContentLoaded", function () {
    let metaTag = document.querySelector('meta[name="Admin-plants-get-dmg"]');
    ...
    let catTable = document.getElementById("plantsLogDamageTable");
    if (!catTable) {
        console.error("Table tidak ditemukan di halaman ini.");
        return;
    }

    $("#plantsLogDamageTable").DataTable({
        processing: true,
        serverSide: true,
        ajax: {
...
$(document).on('click', '#setsss', function() {
    var cp = $(this).data('cp');
    var pd = $(this).data('pd');
    var sn = $(this).data('sn');
    var nt = $(this).data('nt');
