...
document.addEventListener("DOMContentLoaded", function () {
    let metaTag = document.querySelector('meta[name="Admin-plants-get-na"]');
    ...
    let catTable = document.getElementById("plantsLogNeedAttTable");
    if (!catTable) {
        // console.error("Table tidak ditemukan di halaman ini.");
        return;
    }

    $("#plantsLogNeedAttTable").DataTable({
        processing: true,
        serverSide: true,
        ajax: {
...
$(document).on('click', '#setss', function() {
    var cp = $(this).data('cp');
    var pd = $(this).data('pd');
    var sn = $(this).data('sn');
    var nt = $(this).data('nt');
